...
def calculate_total_ticket_cost(no_of_adults, no_of_children):
    ...
    total_before_tax = no_of_adults * 37550.0 + no_of_children * 37550.0 * (1/3) 
    total_after_tax = total_before_tax * 7/100 + total_before_tax
    total_ticket_cost = total_after_tax * 90/100
